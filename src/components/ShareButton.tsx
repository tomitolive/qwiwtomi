...
export default function ShareButton({ url, title }: ShareButtonProps) {
  ...
  const encodedTitle = encodeURIComponent(title || 'توميتو');
    ...
    <div ref={ref} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {open && (
        ...
        >
          ...
          {/* Divider */}
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', margin: '4px 8px' }} />
          ...
          <button
            ...
            onMouseLeave={(e) => (e.currentTarget.style.background = 'transparent')}
          >
            <span style={{ color: copied ? '#4ade80' : '#aaa', flexShrink: 0 }}>
              {copied ? (
