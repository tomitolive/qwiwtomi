...
export default function SocialBar() {
  ...
  return (
    <>
      {/* ── MOBILE VERSION (Old Layout) ── */}
      <div className="fixed top-20 right-4 z-[10000] max-w-sm md:hidden">
      ...
      {/* ── DESKTOP VERSION (New Layout + Ad) ── */}
      <div className="fixed top-20 right-4 z-[10000] max-w-xs hidden md:block">
