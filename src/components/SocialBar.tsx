      ...
      <div className="bg-[#0f0f11] rounded-xl shadow-[0_0_30px_rgba(0,0,0,0.8)] border border-zinc-700 overflow-hidden relative">
        ...
        <div className="w-full bg-black">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 py-3 bg-zinc-800 hover:bg-zinc-700 transition-colors border-t border-zinc-700 group"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              ...
              strokeLinecap="round"
              strokeLinejoin="round"
              className="w-6 h-6 text-zinc-400 group-hover:text-red-400 transition-colors"
            >
              <circle cx="12" cy="12" r="10" />
              <path d="M15 9l-6 6M9 9l6 6" />
            </svg>
            <span className="text-zinc-400 group-hover:text-red-400 text-base font-bold transition-colors">
              Remove Ad &nbsp;/&nbsp; إزالة الإعلان
            </span>
          </button>

          {/* Ad banner */}
          <div className="min-h-[50px] max-h-[250px] overflow-hidden">
