...
export default function VastAd() {
  ...
  return (
    <div style={{ textAlign: "center", margin: "0 auto 10px auto", overflow: "hidden", maxWidth: "728px", minHeight: "90px", border: "1px dashed #333", padding: "5px" }}>
      <ins
